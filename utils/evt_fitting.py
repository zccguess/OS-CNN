...
def weibull_tailfitting(
    ...
    tailtofit = sorted(distance_scores)[-tailsize:]##当tailsize为1时得到所在类别最大距离
    mr.fit_high(tailtofit, len(tailtofit))###################EVT Fit
    # print(type(mr))
    # print(mr.fit_high(tailtofit, len(tailtofit)))
    # print(mr.w_score(0))
    # print(mr.w_score(-1))
    # print(mr.w_score(100))
...
def query_weibull(
    ...
    return category_weibull###返回0，1，3，5，7，9的weibull
